...
<form action="validarlogueodocente.php" method="post" class="formulario_de_registrado">
...
<form action="registraryvalidardocente.php" method="post" class="formulario_de_registro">
		<h2 class="titulo_formulario">REGISTRATE EN EL OVA</h2>
		<div class="los-inputs">
			<input type="number" name="iddocente" required placeholder="Identificación" class="input-47">
			...
			<input type="text" name="area" required placeholder="Area Del Conocimiento" class="input-47">
			<input type="text" name="institucion" required placeholder="Institucion" class="input-100">
